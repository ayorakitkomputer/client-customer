<template>
  <div class="container h-screen mx-auto bg-my-build">
    <div>
    ...
    <section v-for="build in getUserBuilds" :key="build._id">
      ...
      >
        ...
        <div class="flex gap-4 text-lg font-semibold text-white flex-nowrap">
          <!-- CPU -->
          ...
          <div
            ...
            class="build-card"
          >
            <img class="object-scale-down w-40 h-40" :src="gpu.image" alt="" />
            <h1 class="px-3 pt-4">
