<template>
  <section class="h-navbar">
    <div class="container grid h-full grid-cols-12 mx-auto bg-build rounded-xl">
      <div class="h-full col-span-2 bg-build rounded-xl">
        ...
        <div class="flex flex-col justify-between">
          ...
          >
            ...
            <router-link :to="`/builds/${getBuild._id}/motherboard`">
            ...
            <router-link :to="`/builds/${getBuild._id}/power_supply`">
              <li class="flex justify-between mb-3 bg-comp">
          ...
          <div v-if="checkBuildsRoute" class="mx-5 mt-10">
            ...
            <div class="flex flex-col items-center mt-8 text-lg text-center">
              <button
                @click="checkOutBuild"
...
export default {
  ...
  methods: {
    ...
    goBackToBuilds() {
      ...
      if (currentBuild._id) this.$router.push(`/builds/${currentBuild._id}`);
